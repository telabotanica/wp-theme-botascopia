...
<?php if (isset($_GET['p'])): ?>
    ...
    <div >
        <div>
            <a href="<?php the_field('lien_eflore'); ?>">Nom scientifique : <?php the_field('nom_scientifique'); ?></a>
        </div>
    ...
    <?php
        $args = [
            ...
            'field_groups'    => [12], // L'ID du post du groupe de champs
