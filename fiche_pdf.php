                ...
                <?php if ($description): ?>
                    <div class="characteristic">
                        ...
                        <?php if (!empty($photo)): ?>
                            ...
                            $index_photos++;
                            ?>
                            <div class="section-image" style="align-items:baseline"><?php echo wp_get_attachment_image($photo['id'], 'large'); ?><div class="picture-ref"><?php echo $index_photos;?></div></div>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </main>
