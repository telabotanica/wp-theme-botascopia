                        ...
                        <div>
                            <p class="agro_ecologie">
                                ...
                                <?php if (!empty(get_field('interaction_avec_le_vivant_cette_plante_est-elle_utilisee_comme_plante_compagne_'))): ?>
                                    <br>Cette plante est utilisée comme plante compagne des <?php echo var_dump(get_field('interaction_avec_le_vivant_cette_plante_est-elle_utilisee_comme_plante_compagne_'));?>.
                                <?php endif; ?>
