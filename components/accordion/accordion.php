			...
			if (in_array($name,$tab_names)){
				...
				if (!empty($fd)){
					...
					foreach ($fd as $key => $sub_field){
						...
						$ignore_arr = ['type','categorie','localisation_des_poils','limbe_des_feuilles_simples','tige_aerienne','soudure_du_perigone','soudure_du_calice','soudure_de_landrocee','soudure_de_la_corolle','soudure_des_carpelles','ovaire','limbe_des_folioles','periode_de_levee','feuillage','au_bout_de_combien_de_temps_la_moitie_du_stock_semencier_a_perdu_son_pouvoir_germinatif_'];
