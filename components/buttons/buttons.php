<?php function botascopia_component_buttons($data) {
  ...
  $data->modifiers = botascopia_styleguide_modifiers_array(['component', 'component-buttons'], $data->modifiers);
  ...
  if ( $data->items ):
    ...
    foreach ($data->items as $item) :
      ...
      the_botascopia_module('button', $item);
