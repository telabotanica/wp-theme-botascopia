 ...
 * @return string
 */
function botascopia_format_place( $place ) {
 ...
 */
function botascopia_image_credits( $image, $class = '' ) {
  if ( !$image ) return;
 ...
 * Maintenance page
 */
if ( ! function_exists( 'botascopia_maintenance_mode' ) ) {
  function botascopia_maintenance_mode() {
    if ( file_exists( ABSPATH . '.maintenance' ) ) {
      include_once get_stylesheet_directory() . '/maintenance.php';
      die();
    }
  }
  add_action( 'wp', 'botascopia_maintenance_mode' );
}
